...
#ifndef KNEIGHBOURORDEREDFORWARDING_H_
#define KNEIGHBOURORDEREDFORWARDING_H_
...
class KNeighbourOrderedForwarding: public cSimpleModule
{
    protected:
...
#define KNEIGHBOURORDEREDFORWARDING_SIMMODULEINFO         " KNeighbourOrderedForwarding>!<" << simTime() << ">!<" << getParentModule()->getFullName()

#define KNEIGHBOURORDEREDFORWARDING_MSG_ID_HASH_SIZE      4 // in bytes
#define KNEIGHBOURORDEREDFORWARDING_CACHESIZE_REP_EVENT   175
...
#endif /* KNEIGHBOURORDEREDFORWARDING_H_ */
=======
//
// The model for the Epidemic Routing where neighbours
// are ordered based on a selected set of criteria.
