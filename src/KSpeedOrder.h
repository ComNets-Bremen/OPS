...
#ifndef KSPEEDORDER_H_
#define KSPEEDORDER_H_
...
class KSpeedOrder: public cSimpleModule
{
    protected:
...
#define KSPEEDORDER_SIMMODULEINFO         " KSpeedOrder>!<" << simTime() << ">!<" << getParentModule()->getFullName()

#define KSPEEDORDER_MSG_ID_HASH_SIZE      4 // in bytes
#define KSPEEDORDER_CACHESIZE_REP_EVENT   175
