...
#ifndef KRSSILayer_H_
#define KRSSILayer_H_
...
class KRSSILayer: public cSimpleModule
{
    protected:
...
#define KRSSILAYER_SIMMODULEINFO         " KRSSILayer>!<" << simTime() << ">!<" << getParentModule()->getFullName()

#define KRSSILAYER_MSG_ID_HASH_SIZE      4 // in bytes
#define KRSSILAYER_CACHESIZE_REP_EVENT   175
